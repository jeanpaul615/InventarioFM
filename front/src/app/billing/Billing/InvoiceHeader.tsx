...
const InvoiceHeader: React.FC<InvoiceHeaderProps> = ({ currentBillId, customer }) => (
  <Box sx={{ mb: 4 }}>
    ...
    >
      ...
      />
      <Box>
        <Typography variant="h5" sx={{ fontWeight: 900, color: "#1976d2", letterSpacing: 1 }}>
          FERREMOLINA S.A.S.
        </Typography>
      ...
      >
        <Typography sx={{ color: "#1976d2", fontWeight: 700, fontSize: 16 }}>
          Factura de Venta
        </Typography>
        <Typography sx={{ color: "#37474f", fontSize: 14 }}>
    ...
    >
      <Typography sx={{ color: "#1976d2", fontWeight: 700, mb: 2 }}>
        Datos del Cliente
      </Typography>
